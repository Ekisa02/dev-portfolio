...
const terminalData = {
                ...
                if (project) {
                    ...
                    <div class="cmd-output">
                        <div class="project-details">
                            <h3 style="color: var(--terminal-green);">${project.title}</h3>
                            <p><strong style="color: var(--terminal-blue);">Role:</strong> ${project.role}</p>
                            <p><strong style="color: var(--terminal-blue);">Status:</strong> ${project.status}</p>
                            <p><strong style="color: var(--terminal-blue);">Description:</strong> ${project.detailedDescription}</p>
                            <p><strong style="color: var(--terminal-blue);">Technologies:</strong> ${project.technologies.join(', ')}</p>
                            <p><strong style="color: var(--terminal-blue);">Key Features:</strong></p>
                            <ul>
                                ${project.features.map(feature => `<li>${feature}</li>`).join('')}
                            </ul>
                            <p><strong style="color: var(--terminal-blue);">Impact:</strong> ${project.impact}</p>
                        </div>
                    </div>
                    `;
                } else {
                    return `<div class="cmd-output"><p style="color: var(--terminal-red);">Project '${args.join(' ')}' not found. Type 'projects' to see available projects.</p></div>`;
                }
            }
        },
        experience: {
            ...
            execute: () => {
                ...
                <div class="cmd-output">
                    ...
                    ${terminalData.experience.map(exp => `
                        <div class="cmd-item">
                            <div class="cmd-title">${exp.title} - ${exp.company}</div>
                            <div class="cmd-desc" style="color: var(--terminal-yellow);">${exp.period}</div>
        ...
        achievements: {
            ...
            execute: () => {
                ...
                <div class="cmd-output">
                    ...
                    ${terminalData.achievements.map(achievement => `
                        <div class="cmd-item">
        ...
        skills: {
            ...
            execute: () => {
                ...
                <div class="cmd-output">
                    ...
                    ${Object.entries(terminalData.skills).map(([category, skills]) => `
                        <div class="cmd-item">
    ...
    projects: [
        {
            ...
            description: "Mobile application tracking gender-based activities and policies with real-time community feedback.",
            detailedDescription: "A comprehensive mobile solution that tracks gender-based activities and policies across multiple counties. Integrates policy analysis with reporting dashboard for real-time community feedback and engagement.",
            technologies: ["Android", "Java", "Firebase", "Google Maps API", "REST APIs", "Data Visualization"],
            ...
            impact: "Empowers communities with real-time gender policy insights and facilitates better policy-making through data-driven feedback.",
            keywords: ["wee", "gender", "tracker", "policy"]
        },
        {
            id: 2,
            title: "AgroShield360° App",
            description: "AI-powered mobile application for crop disease detection and farm management.",
            detailedDescription: "An innovative mobile application designed to empower smallholder farmers with AI-powered crop disease detection, farm-level data monitoring, and a built-in marketplace for agro-inputs. Promotes climate-smart farming and data-driven agricultural practices.",
            technologies: ["AI/ML", "React Native", "Python", "TensorFlow", "Cloud Computing", "Computer Vision"],
            status: "Live on Google Play",
            ...
            impact: "Helps smallholder farmers reduce crop losses by up to 40%, improve productivity, and access better market opportunities.",
            keywords: ["agro", "shield", "360", "farm", "agriculture", "ai"]
        },
        {
            id: 3,
            title: "JusticeNet App",
            description: "Legal assistance and rights awareness platform for underserved communities.",
            detailedDescription: "A civic-tech mobile application providing legal assistance, rights awareness, and access to justice resources for underserved communities. Features include legal document templates, lawyer directory, and rights education modules.",
            technologies: ["Flutter", "Node.js", "MongoDB", "Firebase Auth", "Payment Integration"],
            ...
            impact: "Increases access to legal resources and rights awareness for communities with limited legal support.",
    ...
    experience: [
        {
            ...
            company: "EkisaTech",
            period: "2022 - Present",
            description: "Leading development of mobile applications focused on social impact and innovation.",
            achievements: [
        ...
        },
        {
            ...
            period: "2023",
            description: "Conducted mobile application development training sessions for students and professionals.",
            achievements: [
    ...
    achievements: [
        ...
        },
        {
            ...
            organization: "University of Eldoret",
            date: "2023",
            description: "Awarded 2nd place for innovative mobile application solution addressing community needs."
        },
        {
            id: 3,
            ...
            date: "2024",
            description: "Presented mobile innovations and developments to academic and industry professionals."
        },
        {
            id: 4,
            ...
            date: "2023",
            description: "Certified in Intellectual Property rights and patent processes for tech innovations."
        },
        {
            id: 5,
    ...
    skills: {
        "Mobile Development": ["Android", "React Native", "Flutter", "Kotlin", "Java", "Dart"],
        "AI & Machine Learning": ["TensorFlow", "PyTorch", "Computer Vision", "Natural Language Processing", "ML Models"],
        "Backend Technologies": ["Node.js", "Python", "Firebase", "REST APIs", "GraphQL", "MongoDB"],
        "Cloud & DevOps": ["AWS", "Google Cloud", "Docker", "CI/CD", "Kubernetes", "Git"],
        "Tools & Platforms": ["Android Studio", "VS Code", "Figma", "Postman", "GitHub", "Google Play Console"],
        "Architecture & Design": ["MVVM", "Clean Architecture", "Microservices", "API Design", "System Design"]
    }
};
